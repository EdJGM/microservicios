package edu.espe.authservice.dataloader;

import edu.espe.authservice.model.Role;
import edu.espe.authservice.model.User;
import edu.espe.authservice.repository.RoleRepository;
import edu.espe.authservice.repository.UserRepository;
